        ...
        extends AbstractParser
{
            ...
            throws IOException
    {
        ...
        MutableDataHolder flexmarkOptions = PegdownOptionsAdapter.flexmarkOptions( Extensions.ALL & ~(Extensions.HARDWRAPS) ).toMutable();
        ...
        com.vladsch.flexmark.parser.Parser parser = com.vladsch.flexmark.parser.Parser.builder( flexmarkOptions ).build();
        ...
        StringBuilder html = new StringBuilder( markdownHtml.length() + 1000 );
        html.append( "<html>" );
        html.append( "<head>" );
        ...
        if ( !haveTitle && rootNode.hasChildren() )
        {
            ...
            {
                if ( !(firstNode instanceof HtmlCommentBlock) ) break;
