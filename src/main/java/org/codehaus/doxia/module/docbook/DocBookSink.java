...
public class DocBookSink extends SinkAdapter
{
    ...
    protected void graphicElement()
    {
        ...
        {
            String format =
                FileUtil.fileExtension( graphicsFileName ).toUpperCase();
            if ( format.length() == 0 )
                format = "JPEG";
    ...
    public void table_()
    {
        ...
        else
        {
            ...
            markup( "<informaltable frame=\"" + frame + "\" rowsep=\"" + sep +
                    "\" colsep=\"" + sep + "\">\n" );
            out.write( tableRows, /*preserveSpace*/ true );
    ...
    public void tableCaption()
    {
        ...
        markup( "<table frame=\"" + frame + "\" rowsep=\"" + sep +
                "\" colsep=\"" + sep + "\">\n" );
        markup( "<title>" );
    }
    ...
    public void link( String name )
    {
        ...
        {
            // First char of ID cannot be a digit.
            markup( "<link linkend=\"a." +
                    StructureSink.linkToKey( name ) + "\">" );
        }
    }
